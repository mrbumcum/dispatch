      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <Card className="glass border-border/50">
            <CardHeader>
              <CardTitle className="text-2xl">Radio Simulation</CardTitle>
              <CardDescription>
                Practice radio communication protocols and dispatch procedures
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <Radio className="w-24 h-24 mx-auto mb-6 text-muted-foreground opacity-50" />
                <p className="text-lg text-muted-foreground">
                  This feature is coming soon...
                </p>
                <p className="text-sm text-muted-foreground mt-2">
                  Radio simulation functionality will be available in a future update.
                </p>
              </div>
            </CardContent>
          </Card>
