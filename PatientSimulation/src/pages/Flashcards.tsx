        ...
        <div className="max-w-4xl mx-auto">
          <Card className="glass border-border/50">
            <CardHeader>
              ...
              <CardDescription>
                Study and review EMT protocols, medications, and procedures
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <BookOpen className="w-24 h-24 mx-auto mb-6 text-muted-foreground opacity-50" />
                <p className="text-lg text-muted-foreground">
                  This feature is coming soon...
                </p>
                <p className="text-sm text-muted-foreground mt-2">
                  Flashcard functionality will be available in a future update.
                </p>
              </div>
            </CardContent>
          </Card>
