...
const Flashcards = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-900 to-pink-900 transition-colors duration-500 relative overflow-hidden">
      {/* Animated background */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(76,29,149,0.3),rgba(0,0,0,0))]" />
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-semibold text-white tracking-wide drop-shadow-lg">
              {decks[currentDeck]?.name || "Flashcards"}
            </h1>
            <div className="flex items-center gap-3">
              <Button
                ...
                variant="outline"
                size="sm"
                className="hover:scale-105 transition-transform duration-300 bg-white/10 border-white/20 text-white hover:bg-white/20"
              >
